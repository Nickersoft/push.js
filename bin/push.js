  ...
  _createClass(Permission, [{
    ...
    value: function _requestAsPromise() {
      ...
      var i = this.get();var t = function t(i) {
        ...
        var r = function r(i) {
          return t(i) ? o() : h();
        };s ? r(i) : e ? _this2._win.Notification.requestPermission().then(function (i) {
          r(i);
        }).catch(h) : n ? _this2._win.webkitNotifications.requestPermission(function (i) {
          r(i);
        }) : o();
      });
    }
